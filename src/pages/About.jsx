        ...
        <motion.section className="about-main" initial={{ x: window.innerWidth }}
            ...
            <section className="about">
                ...
                <div className="skills">
                    ...
                    <p>This is a list of my foundational full-stack development skills. I'm also familiar with other related tools. If you're curious as to whether I can use a specific tool, feel free to contact me and ask.</p>
                </div>
            </section>
